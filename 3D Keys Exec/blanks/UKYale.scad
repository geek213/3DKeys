...
//notch_width==1; }
	...
	difference(){
      ...
      if (makeblank) {
		...
		if (cutter_style==0) {
		   if (makebump) {
			cutter(1 + (notch_spacer-4) + pattern_offset,notch_baseZ + (bits[0]*notch_offsetZ),0.5,notch_angle);
			cutter(1 +  notch_spacer    + pattern_offset,notch_baseZ + (bits[0]*notch_offsetZ),0.5,notch_angle);
			cutter(1 + (notch_spacer*3) + pattern_offset,notch_baseZ + (bits[1]*notch_offsetZ),0.5,notch_angle);
			cutter(1 + (notch_spacer*5) + pattern_offset,notch_baseZ + (bits[2]*notch_offsetZ),0.5,notch_angle);
			cutter(1 + (notch_spacer*7) + pattern_offset,notch_baseZ + (bits[3]*notch_offsetZ),0.5,notch_angle);
			cutter(1 + (notch_spacer*9) + pattern_offset,notch_baseZ + (bits[4]*notch_offsetZ),0.5,notch_angle);

         }else{
			cutter(1 +  notch_spacer    + pattern_offset,notch_baseZ + (bits[0]*notch_offsetZ),notch_width,notch_angle);
			cutter(1 + (notch_spacer*3) + pattern_offset,notch_baseZ + (bits[1]*notch_offsetZ),notch_width,notch_angle);
			cutter(1 + (notch_spacer*5) + pattern_offset,notch_baseZ + (bits[2]*notch_offsetZ),notch_width,notch_angle);
			cutter(1 + (notch_spacer*7) + pattern_offset,notch_baseZ + (bits[3]*notch_offsetZ),notch_width,notch_angle);
			cutter(1 + (notch_spacer*9) + pattern_offset,notch_baseZ + (bits[4]*notch_offsetZ),notch_width,notch_angle);
         }
		   ...
		   if (makebump) {
			...
			polygon(points=[
				...
				[1+pattern_offset+(notch_spacer)				        , notch_baseZ + (bits[0]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer)                  , notch_baseZ + (bits[0]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*1)				     , notch_baseZ + (bits[1]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*1)+(notch_width*1), notch_baseZ + (bits[1]*notch_offsetZ)],
				...
				[1+pattern_offset+(notch_spacer*3)+(notch_width*2), notch_baseZ + (bits[3]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*3)+(notch_width*3), notch_baseZ + (bits[3]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*4)+(notch_width*3), notch_baseZ + (bits[4]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*4)+(notch_width*4), notch_baseZ + (bits[4]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*5)+(notch_width*4), notch_baseZ + (bits[4]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*5)+(notch_width*5), notch_baseZ + (bits[4]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*8)+(notch_width*5), 5],
			]);
         }else{
			polygon(points=[
				[1+pattern_offset-(notch_spacer*10)				  , 5],
				[1+pattern_offset+(notch_spacer*1)				  , notch_baseZ + (bits[0]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*1)+(notch_width*1), notch_baseZ + (bits[0]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*2)+(notch_width*1), notch_baseZ + (bits[1]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*2)+(notch_width*2), notch_baseZ + (bits[1]*notch_offsetZ)],
				...
				[1+pattern_offset+(notch_spacer*4)+(notch_width*3), notch_baseZ + (bits[3]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*4)+(notch_width*4), notch_baseZ + (bits[3]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*5)+(notch_width*4), notch_baseZ + (bits[4]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*5)+(notch_width*5), notch_baseZ + (bits[4]*notch_offsetZ)],
				[1+pattern_offset+(notch_spacer*8)+(notch_width*5), 5],
			]);
