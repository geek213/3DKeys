        ...
        // Do the actual bitting
	     ...
	     if (makebump) {
            //for (b = [0:5]) {
                ...
                translate([shoulder + 5*pin_spacing, width - bits[5]*depth_inc - fudge, 0]) bit(512);
                translate([shoulder + 6*pin_spacing, width - bits[5]*depth_inc - fudge, 0]) bit(512);
            //}
        }
    }
}
